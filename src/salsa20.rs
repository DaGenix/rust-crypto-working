...
mod test {
    ...
    #[test]
    pub fn test_salsa20() {
        test_synchronous_stream_cipher(
            "testdata/salsa20.toml",
            64,
            |key, iv| Salsa20::new(key, iv)
        );
    }

    #[test]
    pub fn test_xsalsa20() {
        test_synchronous_stream_cipher(
            "testdata/salsa20-xsalsa20.toml",
            64,
            |key, iv| Salsa20::new_xsalsa20(key, iv)
        );
    }
}

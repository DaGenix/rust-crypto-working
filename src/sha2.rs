...
mod tests {
    ...
    #[test]
    fn test_sha512() {
        test_digest("testdata/sha2-512.toml", 128, || Sha512::new());
    }

    #[test]
    fn test_sha512_256() {
        test_digest("testdata/sha2-512-256.toml", 128, || Sha512Trunc256::new());
    }

    #[test]
    fn test_sha512_224() {
        test_digest("testdata/sha2-512-224.toml", 128, || Sha512Trunc224::new());
    }

    #[test]
    fn test_sha384() {
        test_digest("testdata/sha2-384.toml", 128, || Sha384::new());
    }

    #[test]
    fn test_sha256() {
        test_digest("testdata/sha2-256.toml", 128, || Sha256::new());
    }

    #[test]
    fn test_sha224() {
        test_digest("testdata/sha2-224.toml", 128, || Sha224::new());
    }
}
